---
title: "Glossary: OpenClaw Vocabulary Reference"
description: "An alphabetized reference of OpenClaw-specific terms, each defined in one or two sentences with a pointer to its home chapter."
category: reference
type: reference
tags: [glossary, reference, vocabulary, terminology, agent, gateway, session, channel, binding, plugin, tool, skill, hook, compaction, memory, heartbeat, queue, bootstrap, subagent, dreaming, soul, harness, JSONL, wire-protocol]
keywords: [openclaw terms, openclaw definitions, openclaw vocabulary, agent loop, session lane, global lane, queue mode, effective tool policy, DM pairing, node pairing, auth profile, ThinkingLevel, openclaw doctor, compaction, dreaming subagent, memory plugin slot, bootstrap file]
sources: [S1, S2, S15, S16, S17, S19, S22, S23, S24, S27, S33, S60, S68, S95, S114]
---
...
# Glossary: OpenClaw Vocabulary Reference
...
→ [Memory System](../memory/10-memory-system.md)
...
→ [The Agent Loop](../agents/06-agent-loop.md)
...
→ [Multi-Agent Coordination](../coordination/16-multi-agent.md)
...
→ [Configuration System](../operations/18-configuration.md)
...
→ [Agents](../agents/05-agents.md) · [System Prompt and Context](../agents/09-system-prompt.md)
...
→ [System Prompt and Context](../agents/09-system-prompt.md)
...
→ [Channels](../channels/04-channels.md)
...
→ [Plugins, Skills, and Tools](../extending/11-plugins-skills-tools.md)
...
→ [Automation and Scheduling](../automation/17-automation.md)
...
→ [Security and Governance](../operations/20-security.md)
...
→ [Sessions](../agents/07-sessions.md)
...
→ [Memory System](../memory/10-memory-system.md) · [Automation and Scheduling](../automation/17-automation.md)
...
→ [Tool System](../extending/12-tool-system.md)
...
→ [Gateway](../gateway/03-gateway.md) · [High-Level Architecture](../getting-started/02-architecture.md)
...
→ [Run Queue and Concurrency](../agents/08-run-queue.md)
...
→ [Agent Loop Hooks](../extending/14-hooks.md)
...
→ [Sessions](../agents/07-sessions.md) · [Storage and Persistence](../operations/19-storage.md)
...
→ [AI Model Integration](../models/15-model-integration.md)
...
→ [Configuration System](../operations/18-configuration.md) · [Best Practices](./26-best-practices.md)
...
→ [Sessions](../agents/07-sessions.md) · [Run Queue and Concurrency](../agents/08-run-queue.md)
...
→ [Storage and Persistence](../operations/19-storage.md)
...
← Previous: [Best Practices: Configuration, Security, Tool Policy, Sessions, Observability](./26-best-practices.md)
